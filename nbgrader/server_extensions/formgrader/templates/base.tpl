  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2" '>
        ...
        <img src="https://ik.imagekit.io/iwwbj9so6/LOGO_-_data_science_lab_QYUIsnln7.png?ik-sdk-version=javascript-1.4.3&updatedAt=1658915400748" class='career-logo'/>  
        </div>
      </div>
      <div class="col-md-8">
        <div class="page-header">
